...
set_dont_touch_network {UART_CLK_TX UART_CLK_RX}
...
set_input_delay $in_delay -clock $CLK2_NAME [remove_from_collection [all_inputs] [get_ports {TX_CLK RX_CLK RST}]]
...
set_driving_cell -no_design_rule -max -lib_cell NBUFFX4_RVT [remove_from_collection [all_inputs] [get_ports {TX_CLK RX_CLK}]]
